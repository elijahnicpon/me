<template>
    <div class="bottom-bar items-center flex justify-between border space-x-6 p-0 border-vscode-dark-border">
        ...
        <div class=" flex">
            ...
            <a href="https://www.linkedin.com/in/elijah-nicpon/" target="_blank" rel="noopener noreferrer" class="flex flex-row items-center p-3 border-l border-vscode-dark-border fill-vscode-dark-text hover:fill-white hover:text-white hover:bg-vscode-dark-hover ">
